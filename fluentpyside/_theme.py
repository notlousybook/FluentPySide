...
class ThemeManager(QObject):
    ...
    def __init__(self):
        ...
        try:
            self.current_theme = FluentConfig["theme"]["current_theme"]
    ...
    def apply_backdrop_effect(self, effect_type: str):
        ...
        FluentConfig["backdrop_effect"] = effect_type
        # print(
    ...
    def _apply_win10_effect(self, effect_type, hwnd):
        ...
        """
        backdrop_color = FluentConfig["win10_feat"][
    ...
    def _update_window_theme(self):  # 更新窗口的颜色模式
        ...
        for hwnd in self.windows:
            if is_win11():
                ...
                is_win10()
                and FluentConfig["backdrop_effect"] == BackdropEffect.Acrylic.value
            ):
                self._apply_win10_effect(FluentConfig["backdrop_effect"], hwnd)
            else:
    ...
    def toggle_theme(self, theme: str):  # 切换主题
        ...
        if self.current_theme != theme:
            ...
            FluentConfig["theme"]["current_theme"] = theme
            self._update_window_theme()
            self.themeChanged.emit(self._actual_theme())
    ...
    def get_backdrop_effect(self):
        """获取当前背景效果"""
        return FluentConfig["backdrop_effect"]

    @Slot(str)
    def set_theme_color(self, color):
        """设置当前主题颜色"""
        FluentConfig["theme_color"] = color
        FluentConfig.save_config()

    @Slot(result=str)
    def get_theme_color(self):
        """获取当前主题颜色"""
        return FluentConfig["theme_color"]
