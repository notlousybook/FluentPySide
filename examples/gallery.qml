// gallery.qml — FluentPySide Gallery (NavigationView sidebar layout)
// Sidebar navigation with collapsible NavigationView, smooth transitions.
import QtQuick
...
ApplicationWindow {
    ...
    // ================================================================
    // MAIN LAYOUT — NavigationView sidebar + content
    // ================================================================
    NavigationView {
        id: navView
        anchors.fill: parent
                            ...
                            Grid {
                                ...
                                Repeater {
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        Behavior on cardScale { NumberAnimation { duration: 200; easing.type: Easing.OutCubic } }

                                        transform: Scale {
                                            origin.x: categoryCard.width / 2
                                            origin.y: categoryCard.height / 2
                                            xScale: categoryCard.cardScale
                                            yScale: categoryCard.cardScale
                                        }
